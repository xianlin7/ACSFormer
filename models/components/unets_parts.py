...
class Up(nn.Module):
    ...
    def forward(self, x1, x2):
        x1 = self.up(x1)  # e.g., x1 (b, 1024, 16, 16) -> (b, 512, 32, 32), x2 (b, 512, 32, 32)
        # input is CHW
...
# reference: https://github.com/usuyama/pytorch-unet/blob/master/pytorch_unet.py
...
class BottleNeck(nn.Module):
    '''
    out_channel = middle_channels * expansion
    '''
    expansion = 4
